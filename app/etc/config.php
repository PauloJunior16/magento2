...
return [
    'modules' => [
        ...
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'Doctor_AddAttributesSet' => 1,
        'Doctor_CreateBanner' => 1,
...
Disallow: /*SID=
            ...
            'general' => [
                ...
                'region' => [
                    'display_all' => '1',
                    'state_required' => 'AU,BR,BG,CA,CN,CO,HR,EE,IN,IT,LV,LT,MX,PL,RO,ES,CH,US',
                ],
                'store_information' => [
                    'name' => null,
                    'phone' => null,
...
{{depend vat_id}}VAT: {{var vat_id}}{{/depend}}|',
            ...
            'payment' => [
                ...
                'checkmo' => [
                    ...
                    'order_status' => 'pending',
                    'title' => 'Cheque / Ordem de Pagamento',
                    'allowspecific' => '0',
                    'group' => 'offline',
                    'specificcountry' => null,
                    'payable_to' => null,
                ...
                'rm_pagseguro' => [
                    ...
                    'address_neighborhood_attribute' => 'street_4',
                    'merchant_email' => 'gustavo.menezes@webjump.com.br',
                    'token' => 'EA062552FD8B4693AAED1B0260D64AEA',
                    'key' => 'PUBA404C96E73C647A9B12A1EE927EB61D7',
                    'sandbox' => '1',
                    'send_invoice_email' => '1',
                    'customer_cpf_attribute' => null,
                    'sandbox_merchant_email' => 'v04557428840408078346@sandbox.pagseguro.com.br',
                    'sandbox_key' => 'PUBEB99DF189896488B8260636F37C10848',
                ],
                'rm_pagseguro_boleto' => [
                    'active' => '1',
                    'payment_action' => 'order',
            ...
            'carriers' => [
                ...
                'frenetshipping' => [
                    'model' => 'Frenet\\Shipping\\Model\\Carrier\\Frenet',
                    'name' => 'frenet',
                    'version' => '2.1.4',
                    'active' => '1',
                    'title' => 'Frenet Shipping Gateway',
                    'token' => '0:3:CvdTBw8niMXMUeZ+pNAjN9myqqpJwc+d6G3XlAb3+C6/iNz9Z0Y/VE643k/olTer5Gj24A9ra9i3C50XLsXYFg==',
                    'use_default' => '1',
                    'default_height' => '2',
                    'default_length' => '16',
                    'default_width' => '11',
                    ...
                    'weight_type' => 'kg',
                    'show_delivery' => '1',
                    'msgprazo' => '%s - Em média %d dia(s)',
                    'multi_quote' => '0',
                    'add_delivery_days' => '0',
                    'showmethod' => '0',
                    'specificcountry' => null,
                    'sort_order' => '90',
                    'specificerrmsg' => 'Frenet shipping method is not available.',
                    'sallowspecific' => '0',
                    'show_shipping_forecast' => '1',
                    'shipping_forecast_message' => '{{d}} dia(s)',
                    'attributes_mapping' => [
                        'weight_attribute' => 'weight',
                        'height_attribute' => 'volume_height',
                        'length_attribute' => 'volume_length',
                        'width_attribute' => 'volume_width',
                    ],
                    ...
                    'debug' => '1',
                    'debug_filename' => 'frenet_request_debug.log',
                ],
            ],
            'import' => [
                'format_v1' => [
            ...
            'connector_dynamic_content' => [
                ...
                'external_dynamic_content_urls' => [
                    'passcode' => 'Bpna2eGWptggoZ78rg0G3K2YKm2qMRx4',
            ...
            'yotpo' => [
                ...
                'sync_settings' => [
                    ...
                    'orders_sync_start_date' => '2020-12-29',
                ],
                'module_info' => [
                    'yotpo_installation_date' => '2020-12-29',
                ],
            ],
            ...
            'twofactorauth' => [
                'duo' => [
                    'application_key' => 'peQ3ALXy8huGsbF3ctG4xo8JV2TEYHpLbprfjinRYEEBd563Y38UTDJhdLzQjVFq',
                ],
            ],
        ],
        'stores' => [
            ...
            'br' => [
                ...
                'design' => [
                    'header' => [
                        'welcome' => 'Bem vindo a Koala Store!',
                        'logo_width' => '600',
                        'logo_height' => '200',
                        'logo_alt' => 'Koala Strong',
                    ],
                    'footer' => [
                        'copyright' => 'Copyright © 2013-present Magento - Todos os direitos reservados.',
                    ],
                    'theme' => [
                        'theme_id' => 'frontend/Magento/Koala',
                    ],
                ],
            ],
            'en' => [
            ...
            'home' => [
                'design' => [
                    'theme' => [
                        'theme_id' => 'frontend/Magento/Doctor',
                    ],
                ],
            ],
        ],
